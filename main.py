...
def register():
    ...
    if form.validate_on_submit():
        ...
        new_user = User(name=form.name.data, email=email, password=password)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash('email is not registered, check your email or register')
...
if __name__ == "__main__":
    app.run(host='192.168.0.109', debug=True)
